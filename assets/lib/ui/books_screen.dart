  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar.medium(
            title: Text(widget.collectionName, style: TextStyle(fontSize: size.width * .049),),
                      ...
                      return Padding(
                        ...
                        child: ListTile(
                          ...
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.only(topLeft: Radius.circular(12), bottomLeft: Radius.circular(12), topRight: Radius.circular(28), bottomRight: Radius.circular(28)),
                          ),
