    ...
    return Scaffold(
      ...
      floatingActionButton: Column(
        ...
        children: [
          ...
          _buildMenuItem(
            icon: _themeController.isDarkMode ? Icons.light_mode : Icons.dark_mode,
            label: "Theme",
            isDarkMode: _themeController.isDarkMode,
            isObx: true,
          ...
          FloatingActionButton(
            backgroundColor: _expandAnimation.status.isForwardOrCompleted ? colorScheme.primary : Colors.white,
        ...
        slivers: [
          SliverAppBar(
            ...
            title: Row(
              ...
              children: [
                ...
                Text(
                  "Hadith Premium",
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: size.width * .045),
                ),
              ],
            ),
            actions: [
              IconButton(
                icon: Icon(Icons.person_outline, color: _themeController.isDarkMode ? Colors.white : Colors.black,),
                onPressed: () => Get.to(() => const ProfileScreen()),
              ),
              const SizedBox(width: 8),
            ],
          ...
          _loading
            ...
            sliver: SliverGrid(
              ...
              delegate: SliverChildBuilderDelegate((context, index) {
                final item = _collections[index];
                return _CollectionCard(item: item, themeController: _themeController,);
              }, childCount: _collections.length),
            ),
          ),
        ],
          ...
          children: [
            FadeTransition(
              ...
              child: Container(
                ...
                child: Text(
                  label,
                  style: TextStyle(color: isDarkMode ? Colors.black : Colors.white, fontSize: 12, fontWeight: FontWeight.bold),
                ),
              ),
            ),
            ...
            FloatingActionButton.small(
              ...
              child: isNotification
                  ? Obx(() => Badge(
                label: Text(_notificationController.unreadCount.value.toString()),
                isLabelVisible: _notificationController.unreadCount.value > 0,
                child: Icon(icon),
              ))
                  : isObx
                  ? Obx(() => Icon(_themeController.isDarkMode ? Icons.light_mode : Icons.dark_mode))
                  : Icon(icon),
            ),
          ],
        ),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Slider(
                        ...
                        onChanged: (val) => _settingsController.updateFontSize(val),
                      ),
                    ),
                    const Icon(Icons.text_fields, size: 24),
                  ],
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: themeController.isDarkMode ? Colors.white.withOpacity(.21) : Colors.black.withOpacity(.21),
                  shape: BoxShape.circle,
                ),
                child: Text(
